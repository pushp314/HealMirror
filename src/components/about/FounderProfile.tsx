  ...
  return (
    <div className="w-full overflow-hidden">
      <section className="relative bg-[#FFFCF5] pt-1 px-4 sm:px-8 md:px-20 h-auto sm:h-[400px] md:h-[500px]">
        ...
        <div className="absolute right-[-100px] sm:right-[-60px] md:right-[-80px] bottom-[-120px] sm:bottom-[-80px] md:bottom-[-100px] w-[390px] sm:w-[400px] md:w-[700px] z-0 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-end sm:items-end pl-4 mb-3  sm:pl-0 sm:pr-6 md:pr-36 mt-8 sm:mt-0 ">
